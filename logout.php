            ...
            <div class="row">
                <div class="col-12">
                    <nav class="main-nav">
                        ...
                        <ul class="nav">
                            <li class="scroll-to-section"><a href="index.php" style="color: yellow;">Inicio</a></li>
                            <li class="submenu">
            ...
            <div class="item">
                <div class="img-fill">
                    ...
                    <div class="text-content">
                        <h3 class="text-center" style="color: yellow; font-size: 35px;">¡Adios!</h3>
                        <br>
                        <br>
                        <h2 class="text-center" style="color: red;">Tu sesión ha cerrado correctamente</h2>
                    </div>
                </div>
            </div>
        </div>
