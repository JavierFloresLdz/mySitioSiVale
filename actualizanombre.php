            ...
            <div class="row">
                    <div class="left-text-content">
                        <div class="section-heading">
                            <h6>¡Actualiza tu email!</h6>
                            <h2>Ingresa tu nuevo email y tu contraseña para actualizar tus datos</h2>
                        </div>              
                    </div>
                </div>
                        ...
                        <form id="contact" action="" method="POST">
                          <div class="row">
                            <div class="col-md-6 col-sm-12">
                              <fieldset>
                                <input name="email" type="text" id="email" placeholder="Nuevo email" required="">
                              </fieldset>
                            </div>
                            <div class="col-md-6 col-sm-12">
                              <fieldset>
...
if (isset($_POST['validar']))
{
    ...
    if($count) {
        $email = $_POST['email'];
        $conexion = new conexion();
        $query=$conexion->prepare('UPDATE users SET email=:email WHERE celular=:celular');
