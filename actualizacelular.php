            ...
            <div class="row">
                    ...
                    <div class="left-text-content">
                        <div class="section-heading">
                            <h6>¡Actualiza tu celular!</h6>
                            <h2>Ingresa tu nuevo celular y tu contraseña para actualizar tus datos</h2>
                        </div>
                        ...
                        <form id="contact" action="" method="POST">
                          <div class="row">
                            <div class="col-md-6 col-sm-12">
                              <fieldset>
                                <input name="celular" type="text" id="celular" placeholder="Nuevo celular" required="">
                              </fieldset>
                            </div>
                            <div class="col-md-6 col-sm-12">
                              <fieldset>
...
if (isset($_POST['validar']))
{
    ...
    if($count) {
        $celular = $_POST['celular'];
        $conexion = new conexion();
        $query=$conexion->prepare('UPDATE users SET celular=:celular WHERE celular=:celular');
        $query->bindParam(':celular',$celular);
        $query->bindParam(':celular',$celular);
        $query->execute();
                    ...
                    $("#validar").click(function(){
                        if ($("#celular").val() == "") {
                            ...
                            Toast.fire({
                                ...
                                title: 'El Campo celular nuevo es Requerido' 
                            })
                            return false;
                        } else if($("#psw").val() == ""){
                            const Toast = Swal.mixin({
