...
<html lang="en">
  <head>
            ...
            <div class="row">
                    <div class="left-text-content">
                        <div class="section-heading">
                            ...
                            <h2>Ingresa tu nueva contraseña así como tu contraseña anterior para poder actualizar tus datos</h2>
                        </div>              
                    </div>
                </div>
                        ...
                        <form id="contact" action="" method="POST">
                          <div class="row">
                            <div class="col-md-6 col-sm-12">
                              <fieldset>
                                <input name="psw2" type="password" id="psw2" placeholder="Nueva contraseña" required="">
                              </fieldset>
                            </div>
                            <div class="col-md-6 col-sm-12">
                              <fieldset>
                                <input name="psw" type="password" id="psw" placeholder="Contraseña antigua" required="">
                              </fieldset>
                            </div>
                            <div class="col-lg-12">
                              <fieldset>
    ...
    if($count) {
        $psw2 = $_POST['psw2'];
        $conexion = new conexion();
        $query=$conexion->prepare('UPDATE users SET psw=:psw2 WHERE celular=:celular');
        $query->bindParam(':psw2',$psw2);
        $query->bindParam(':celular',$celular);
        $query->execute();
                ...
                $(document).ready(function() {
                    $("#validar").click(function(){
                        if ($("#psw2").val() == "") {
                            ...
                            Toast.fire({
                                icon: 'error',
                                title: 'El Campo contraseña nueva es Requerido' 
                            })
                            return false;
                        } else if($("#psw").val() == ""){
                            const Toast = Swal.mixin({
                            ...
                            Toast.fire({
                                icon: 'error',
                                title: 'El Campo contraseña antigua es Requerido' 
                            })
                            return false;
                        }
                    });
